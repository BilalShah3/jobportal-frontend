      ...
      <div className="modalWrapper">
        <div className="left">
          <div style={{ width: "100%", height: "100%", position: "relative" }}>
            <Image src="/images/resume-upload.svg" alt="resume" layout="fill" priority={true}/>
          </div>
        </div>
        <div className="right">
          <div className="rightContentWrapper">
            ...
            <form className="form" onSubmit={submitHandler}>
              ...
              {user && user.resume && (
                <>
                  <h4 className="text-center my-3">Resume Uploaded {user.resume}</h4>

                  <Link
                    href={`https://jobeee.s3.amazonaws.com/${user.resume}`}
